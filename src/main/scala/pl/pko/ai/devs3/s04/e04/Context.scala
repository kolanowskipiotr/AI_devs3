...
case class Context(
                    ...
                    HQInstructionsRequest: Option[HQInstructionsRequest] = None,
                    claudeResponse: Option[ClaudeResponse] = None,
...
object Context {
  ...
  val cachePath = "src/main/scala/pl/pko/ai/devs3/s04/e04/cache/context.json"
