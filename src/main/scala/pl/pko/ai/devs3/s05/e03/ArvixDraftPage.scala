...
object ArvixDraftPage {
  val content: String =
    """
      ...
      |
      |![Image 13](https://centrala.ag3nts.org/dane/i/rynek.png)
      |
      ...
      |
      |![Image 14](https://centrala.ag3nts.org/dane/i/rynek_glitch.png)
      |
      ...
      |
      |![Image 15](https://centrala.ag3nts.org/dane/i/fruit01.png)
      |
      |Owoc przed transportem w czasie
      |
      |![Image 16](https://centrala.ag3nts.org/dane/i/fruit02.png)
      |
      ...
      |
      |![Image 17](https://centrala.ag3nts.org/dane/i/strangefruit.png)
      |
      ...
      |
      |![Image 18](https://centrala.ag3nts.org/dane/i/resztki.png)
      |
